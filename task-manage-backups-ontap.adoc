...
[NOTE]
====
* 如果您在啟動此叢集的Cloud Backup時、在初始原則中啟用_DataLock和勒索軟體Protection、則您所編輯的任何原則都必須設定相同的DataLock設定（企業或法規遵循）。如果您在啟動Cloud Backup時未啟用_DataLock和勒索軟體Protection、則現在無法啟用DataLock。
...
[NOTE]
====
* 如果您在啟動此叢集的Cloud Backup時、在初始原則中啟用_DataLock和勒索軟體Protection、則您所建立的任何其他原則都必須設定相同的DataLock設定（企業或法規遵循）。如果您在啟動Cloud Backup時未啟用_DataLock和勒索軟體Protection、則無法建立使用DataLock的新原則。
