...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-3.png["三"] 為 Connector 準備網路
[role="quick-margin-para"]
確認連接器具備所需的網路連線。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["四"] 驗證授權要求
[role="quick-margin-para"]
您必須檢查 Google Cloud 和 BlueXP 的授權要求。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["五"] 準備 ONTAP 叢集
[role="quick-margin-para"]
