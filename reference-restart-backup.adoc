...
| 雲端部署 | 請依照的指示進行 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-managing-connectors.html#connect-to-the-linux-vm["連線至 Connector Linux 虛擬機器"^] 視您使用的雲端供應商而定。 
