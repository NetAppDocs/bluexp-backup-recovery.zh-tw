...
--
授權需求:: 對於Cloud Backup PAYGO授權、AWS Marketplace提供訂閱服務、可部署Cloud Volumes ONTAP 支援的功能包括：您需要 https://aws.amazon.com/marketplace/pp/prodview-oorxakq6lq7m4?sr=0-8&ref_=beagle&applicationId=AWSMPContessa["訂閱此 Cloud Manager 訂閱"^] 在啟用Cloud Backup之前。雲端備份計費是透過此訂閱完成。
+
--
