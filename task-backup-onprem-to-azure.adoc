...
+
** 透過連接埠 443 連接到 BlueXP 備份與恢復服務、以及到 Blob 物件儲存設備的 HTTPS 連線 (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["請參閱端點清單"^]）
...
+
** 如需 BlueXP 備份與還原 PAYGO 授權、您需要訂閱 https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview["Azure"^] BlueXP Marketplace 提供使用 BlueXP 備份與還原的方案。BlueXP 備份與還原的帳單是透過此訂閱完成。
