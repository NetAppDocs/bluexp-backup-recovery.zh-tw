...
+
--
* 您已將Kubernetes叢集探索為藍圖XP工作環境。 https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-azure.html["瞭解如何探索Kubernetes叢集"^]。
...
--
支援的 Azure 地區:: 所有 Azure 區域均支援 BlueXP 備份與還原 https://cloud.netapp.com/cloud-volumes-global-regions["支援的地方 Cloud Volumes ONTAP"^]。
